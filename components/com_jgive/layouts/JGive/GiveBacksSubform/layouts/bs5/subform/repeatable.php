...
// Set the correct language constant based on the form (Givebacks or Beneficiary Stories)
$languageConstant = '';
if ($fieldname == 'givebacks')
{
    $languageConstant = 'COM_JGIVE_GIVEAWAY_ADD_NOTE';
}
elseif ($fieldname == 'beneficiaryStories')
{
    $languageConstant = 'COM_JGIVE_BENEFICIARY_STORY_ADD_NOTE';
}
