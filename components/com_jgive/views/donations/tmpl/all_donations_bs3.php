						...
						?>
							<div class="col-xs-12 table-responsive">
								<div class="no-more-tables">
									<table class="table table-striped table-bordered table-hover table-light border mt-3" id="allDonationsList">
									...
									<div class="col-xs-12">
										<strong class="pull-right"><?php echo Text::_('COM_JGIVE_DONATIONS_AMOUNT');?>
											<?php echo $utilitiesObj->getFormattedPrice($totalDonationAmount);?>
										</strong>
									</div>
									<div class="col-xs-12">
										<strong class="pull-right"><?php echo Text::_('COM_JGIVE_DONATIONS_FEE');?>
											<?php echo $utilitiesObj->getFormattedPrice($totalFee);?>
										</strong>
									</div>
									<div class="col-xs-12">
										<strong class="pull-right"><?php echo Text::_('COM_JGIVE_DONATIONS_PLATFORM_FEE_EXCLUDE_AMOUNT');?>
