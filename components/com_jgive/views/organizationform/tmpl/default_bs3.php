			...
			<div class="row">
				<div class="col-xs-12">
					...
					echo HTMLHelper::_('bootstrap.startTabSet', 'myTab', array('active' => 'info')); 
						echo HTMLHelper::_('bootstrap.addTab', 'myTab', 'info', Text::_('COM_JGIVE_ORGANIZATION_DETAILS_HEADING')); 
							echo $this->loadTemplate('info_bs3');
						echo HTMLHelper::_('bootstrap.endTab');

						echo HTMLHelper::_('bootstrap.addTab', 'myTab', 'address', Text::_('COM_JGIVE_ADDRESS_DETAILS_HEADING')); 
