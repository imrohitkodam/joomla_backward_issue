	...
	?>
		...
		<div id="videos">
			<div id="campaignVideo">
				<div class="row campaignVideo">
					<div class="media" id="jg_video_gallery">
						<?php
							...
							foreach ($campaignImageData as $campaignImage)
							{
								...
								<div class="col-xs-6 col-sm-3 jg_image_item af-mb-20">
									<a href="<?php echo $img_path;?>" title="" class="" >
										<div class="jg-image-gallery-inner af-bg-center af-bg-faded af-text-center af-bg-cover af-bg-repn af-embed-responsive af-responsive-embed-16by9" style="background-image: url('<?php echo $img_path;?>');"></div>
									</a>
								</div>
								<?php
							}
