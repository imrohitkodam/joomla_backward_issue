...
?>
	<div class="col-xs-12 col-sm-4 col-md-3 mt-3">
		<div class="thumbnail af-bg-faded pin p-0 border">
				<div class="pin__title af-p-5">
					<h6 class="text-uppercase af-mb-0 af-px-15 af-mt-5 af-text-truncate">
						...
						<h6 class="offset-xs-1 af-mt-0 af-px-10 af-mb-5">
				...
				<div class="pin__info af-px-15 af-mb-10 mt-2">
					<?php
						// Calculate days left
							$date_expire = 0;
					...
					<!-- Total Donation-->
						...
						<div class="progress af-mb-0 offset-xs-1 progress__info">
							<div class="progress-bar progress-bar-success progress__info--color  progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="50" style="width: <?php echo $donated_per . '%';?>">
							</div>
						</div>
						<h6 class="offset-xs-1 af-mt-10">
					...
					<!--Average Donation-->
						...
						<h4 class="offset-xs-1 af-mb-5"><strong><?php echo $jgiveFrontendHelper->getFormattedPrice($avg_amount);?></strong></h4>
						<h6 class="offset-xs-1 af-mt-5">
						...
						<!-- No. of Donors-->
						<div class="clearfix"></div>
							<h4 class="offset-xs-1 af-mb-5"><strong><?php echo $campaignDonorsCount;?></strong></h4>
							<h6 class="offset-xs-1 af-mt-5"><?php echo ($campData['type'] == 'donation') ? Text::_('COM_JGIVE_DONORS') : Text::_('COM_JGIVE_INVESTORS');?></h6>
						<div class="clearfix"></div>
					</div>
			</div>
	</div>
