	...
	<form action="" name="dashboardFilterform" method="post" id="dashboardFilterform">
		<div class="row af-mt-25">
			<div class="col-xs-12 col-sm-5">
				<h4 class="ms-3"><strong><?php echo strtoupper(Text::_('COM_JGIVE_MY_CAMPAIGNS'));?></strong></h4>
			</div>
			<div class="col-xs-12 col-sm-7">
				<ul class="af-d-flex pull-right me-3">
					<?php echo HTMLHelper::_('select.genericlist', $this->promoterDashboardData['dashboardFilterOption'], "dashboard_filters", 'class="form-select" size="1" onchange="this.form.submit();" name="dashboard_filters"',"value", "text",$this->promoterDashboardData['filterData']->dashboard_filters); ?>
				</ul>
				<ul class="pull-right list-inline campaignsform mt-2">
					...
					?>
					<li class="campaign__launch list__separation px-2">
					...
					<li class="campaign__search px-2">
		...
		<div class="row">
			<div class="col-xs-12 campaigns__filter af-pt-10 hide" id="dashboardFilterOptions">
				<?php
					echo $this->loadTemplate("filters_bs5");
				?>
			</div>
