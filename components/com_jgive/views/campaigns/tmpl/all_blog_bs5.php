		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-8 campaignBolgFilters ">
				<form action="" method="post" name="adminForm4" id="adminForm4">
					...
					<ul class="af-d-flex pull-right">
						<?php echo $this->pagination->getLimitBox(); ?>
					</ul>
				</form>
			</div>
			<!-- Filters Div-->
			<div class="col-xs-12 campaign__filter af-d-none" id="displayFilterText">
				...
				<?php
					...
					$jgiveLayout = new FileLayout('campaigns.filters');
...
*/
								...
								<div class="row">
									...
									<?php if (isset($cdata['long_description']) && $cdata['long_description'])
									{
										$cleanHtmlLongDescription = InputFilter::getInstance(array(), array(), 1, 1)->clean($cdata['long_description'], 'html');?>
										<div class="col-lg-10 col-sm-9 col-xs-12 com_jgive_justify long_desc af-text-break">

											<div class="readMore displayFullText" style="-webkit-line-clamp: 4; ?>;">
												<?php
											...
											{?>
												<div>
													<form action="" method="post" name="adminForm2" id="adminForm2">
														...
														<div class="row">
															<div class="col-xs-6 col-md-6">
																<button class="btn btn-success af-w-100" type="submit">
																	<?php
															...
															<div class="col-xs-6 col-md-6">
																	<a
																	target="_blank"
																	class="btn btn-primary af-w-100"
																	href="<?php echo Uri::root() . substr(
...
<script>
	...
	jQuery(document).ready(function(){
		...
		jQuery('.long_desc .displayFullText').each( function(this) {
			if (jQuery(this).length)
			{
				if (jQuery(this).get(0).scrollHeight > jQuery(this).get(0).clientHeight)
				{
					jQuery(this).parent().find('.r-more-less-div').removeClass('d-none');
				}
			}
		});
