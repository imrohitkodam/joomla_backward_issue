...
<div class="js-stools clearfix">
	<div class="clearfix">
		<div class="js-stools-container-bar row">
			<label for="filter_search" class="element-invisible"
				aria-invalid="false"><?php echo Text::_('COM_JGIVE_SEARCH_FILTER_SUBMIT');?>
			</label>

			<div class="col-md-4 col-xs-12 af-mb-10">
				<div class="input-group">
					...
					<span class="input-group-btn">
						<button type="submit" class="btn hasTooltip btn-md btn__filterDonar" title=""
			...
			<div class="col-md-8 col-xs-12 af-mb-10">
