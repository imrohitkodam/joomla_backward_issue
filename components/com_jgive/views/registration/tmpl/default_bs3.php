								...
								<fieldset>
										<a href='<?php
											...
											<div>
												<input 
												id="LOGIN" 
												class="btn btn-success btn-small validate" 
												type="button" 
					...
					<fieldset>
						...
						<div id="registration_form">
							<div class="control-group">
								...
								<div class="controls">
									<input class="inputbox  validate-name" type="text" name="user_name" id="user_name" size="10" maxlength="50" value=""/>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input class="inputbox  validate-email" type="text" name="user_email" id="user_email" size="20" maxlength="100" value=""/>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<input class="inputbox  validate-email" type="text" name="confirm_user_email" id="confirm_user_email" size="20" maxlength="100" value="" />
								</div>
							</div>
<!--
   </fieldset>
