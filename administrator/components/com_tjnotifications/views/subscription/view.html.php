...
class TjnotificationsViewSubscription extends HtmlView
{
	...
	protected function addToolbar()
	{
		...
		{
			ToolbarHelper::custom('subscription.save2new', 'save-new.png', 'save-new_f2.png', 'TOOLBAR_SAVE_AND_NEW', false);
		}

		// If an existing item, can save to a copy.
		if (!$isNew && $canDo->get('core.create'))
		{
			ToolbarHelper::custom('subscription.save2copy', 'save-copy.png', 'save-copy_f2.png', 'TOOLBAR_SAVE_AS_COPY', false);
		}
