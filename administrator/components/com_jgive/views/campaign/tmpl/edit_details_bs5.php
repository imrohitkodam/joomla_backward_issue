...
<div class="row form-horizontal-desktop">
	<div>
		<?php
			...
			{
				echo $this->form->renderField('long_description');
			}
		?>
		...
		<div class="control-group af-d-none creatcamp--mb-0">
			<div class="pull-left clearfix creatcamp__imgprogress"></div>
		</div>
	...
	<div class="span6">
		<?php
			...
			echo $this->form->renderField('lifetimecamp');
		...
		<?php
			...
			echo $this->form->renderField('amount_suggestions');
		?>
		<div class="control-group">
			<?php
