...
/**
 * Organizations view class.
 *
 * @package  JGive
 * @since    2.3.0
 */

class JgiveViewOrganizations extends HtmlView
{
	public $state;
	...
	public function display($tpl = null)
	{
		...
		// Load submenu
		$jgiveHelper->addSubmenu('organizations');
		...
		ToolbarHelper::title(Text::_("COM_JGIVE") . ": " . Text::_('COM_JGIVE_ORGANIZATIONS'), 'list');
	...
	{
		ToolbarHelper::title(Text::_('COM_JGIVE_MANAGER_ORGANIZATIONS'));
		...
		if ($canCreate)
		{
			ToolbarHelper::addNew('organization.add');
		}

		if ($canEdit && !empty($this->items))
		{
			ToolbarHelper::editList('organization.edit');
			$message = array();
		...
		{
			ToolbarHelper::deleteList('', 'organizations.delete');
