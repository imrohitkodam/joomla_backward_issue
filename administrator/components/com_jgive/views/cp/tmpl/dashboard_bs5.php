...
?>
	<form name="adminForm" id="adminForm" class="form-validate" method="post">
		<?php
			...
			?>
		<!-- TJ Bootstrap3 -->
		<div class="tjBs3 jgive-dashboard tjBs5">
			<!-- TJ Dashboard -->
			<div class="tjDB">
				<div id="wrapper">
					<div id="page-wrapper">
										...
										<div class="panel-heading">
											<div class="row">
												...
												<div class="col-xs-9 af-text-right">
													...
													<div class="jg-bashboard-panel-text"><?php echo Text::_('COM_JGIVE_CAMPAIGNS');?></div>
												</div>
											</div>
										</div>
										...
										<div class="panel-heading">
											<div class="row">
												...
												<div class="col-xs-9 af-text-right">
													...
													<div class="jg-bashboard-panel-text"><?php echo Text::_('COM_JGIVE_TOTAL_GOAL_AMOUNT');?></div>
												</div>
											</div>
										</div>
										<div class="panel-footer">
										...
										<div class="panel-heading">
											<div class="row">
												...
												<div class="col-xs-9 af-text-right">
													...
													<div class="jg-bashboard-panel-text"><?php echo Text::_('COM_JGIVE_FUNDED_AMOUNT');?></div>
												</div>
											</div>
										</div>
										<div class="panel-footer">
										...
										<div class="panel-heading">
											<div class="row">
												...
												<div class="col-xs-9 af-text-right">
													...
													<div class="jg-bashboard-panel-text"><?php echo TEXT::_('COM_JGIVE_COMMISION_AMOUNT');?></div>
												</div>
											</div>
										</div>
										<div class="panel-footer">
													...
													<div class="col-sm-12 col-lg-12 col-md-12">
														<div>
															<div class="form-group">
																<label label-default class="form-label"><?php echo Text::_('COM_JGIVE_FROM_DATE');?></label>
																<?php echo HTMLHelper::_('calendar',
																	$backdate, 'fromDate', 'from', '%Y-%m-%d',
																	array('readonly' => 'true' , 'class' => 'jg-bashboard-calender-input')
																); ?>
															</div>

															<div class="form-group">
																<label label-default class="form-label"><?php echo Text::_('COM_JGIVE_TO_DATE');?></label>
																<?php echo HTMLHelper::_('calendar',
