...
<div class="jgive" id="jgive-checkout">
				...
				<div class="checkout-content  checkout-first-step-billing-info" id="billing-info-tab">
					...
					<div  class="row-fluid form-horizontal">
						...
						<div class="control-group jgive_select_user">
							...
							<div class="controls">
								<div id="bloodhound">
										<input class="typeahead form-control" id="contact_name" type="text" placeholder="<?php echo Text::_('COM_JGIVE_SELECT_DONOR');?>" style="z-index: inherit;" autocomplete="unique-field-name" name="unique-name">
	  								<button type="button" class="btn btn-info btn-small" data-bs-target="#newIndividualDonor" data-bs-toggle="modal" title='<?php echo Text::_('COM_JGIVE_NEW_INDIVIDUAL');?>'>
										<?php echo Text::_('COM_JGIVE_NEW_INDIVIDUAL');?></button>
									<button type="button" class="btn btn-info btn-small" data-bs-target="#newIndividualOrganization" data-bs-toggle="modal" title="<?php echo Text::_('COM_JGIVE_NEW_ORGANIZATION');?>">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="campaign_name" name="campaign_name" class="form-control required" readonly="readonly"
								...
								<button type="button" class="button btn btn-info btn-small" data-bs-target="#donationSelectCampaign" data-bs-toggle="modal" title="<?php echo Text::_('COM_JGIVE_SELECT_CAMPAIGN_LABEL');?>">
						...
						<div class="control-group">
							...
							<div class="controls">
								<div class="input-prepend input-group">
									<input type="number" id="donation_amount" name="donation_amount" class="form-control required"
									...
									<span class="input-group-text"><?php echo $this->currencyCode;?></span>
								</div>
							</div>
						</div>
						<?php
						...
						<div class="control-group">
							...
							<div class="controls">
								<?php echo HTMLHelper::calendar('now', 'payment_received_date', 'payment_received_date', Text::_('COM_JGIVE_DATE_FORMAT'));?>
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<div class="input-prepend input-append" id="donation_status" name="donation_status">
									<?php
										$selectClass  = (JVERSION < '4.0.0') ? ' input-medium ' : ' form-select ';
										echo HTMLHelper::_(
											'select.genericlist',
											$this->pstatus,
											'pstatus',
											'class="' . $selectClass . ' pad_status" size="1"',
											'value',
											'text',
											'C',
											'donation_status'
