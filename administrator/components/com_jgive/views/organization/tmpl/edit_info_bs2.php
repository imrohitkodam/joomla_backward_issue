...
<div class="span6">
	...
	<div class="control-group" id="email_group">
		...
		<div class="controls">
			<input type="email" class="validate-email validate-blankspace"  name="jform[email]"
	...
	<div class="control-group jgive_select_user">
		...
		<div class="controls">
			<div id="bloodhound">
				...
				<input class="typeahead"  id="jform_contact_name" type="text"
					...
					<?php
					$link = Route::_('index.php?option=com_jgive&view=individual&layout=edit&tmpl=component');
					echo HTMLHelper::_(
						'bootstrap.renderModal',
						'addInvidualModal',
						array(
								'title'       => Text::_('COM_JGIVE_ADD_NEW_INDIVIDUAL'),
								'backdrop'    => 'static',
								'url'         => $link,
								'height'      => '400px',
								'width'       => '800px',
					...
					if ($this->tmpl != 'component')
					{
						...
						<button type="button" class="button btn btn-info btn-small margin12" data-target="#newIndividualDonor" data-toggle="modal" title='<?php echo Text::_('COM_JGIVE_NEW_INDIVIDUAL');?>'>
