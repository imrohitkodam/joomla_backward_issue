...
<form action="<?php echo Route::_('index.php?option=com_tjvendors&view=payouts&vendor_id=' . $this->input->get('vendor_id', '', 'INTEGER') . '&client=' . $this->input->get('client', '', 'STRING')); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row tjvendor-wrapper">
		<div class="col-md-12 tjvendor-payouts">
					...
					<div class="js-stools-container-bar">
						<div class="btn-toolbar">
							...
							<div class="js-stools-container-selector btn-group pull-right hidden-phone">
								...
								{
									echo HTMLHelper::_('select.genericlist', $this->uniqueClients, "vendor_client", 'class="form-select" size="1" onchange="document.adminForm.submit();"', "client_value", "vendor_client", $this->state->get('filter.vendor_client'));
