 ...
 * @since       2.2
 */
class TjfieldsViewCountry extends HtmlView
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		if ($isNew)
		{
			$viewTitle = $viewTitle . ': ' . Text::_('COM_TJFIELDS_ADD_COUNTRY');
		}
		else
		{
			$viewTitle = $viewTitle . ': ' . Text::_('COM_TJFIELDS_EDIT_COUNTRY');
		}
		...
		{
			ToolbarHelper::title($viewTitle, 'country.png');
		}
