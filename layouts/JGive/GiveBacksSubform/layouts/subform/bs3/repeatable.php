...
<div class="row-fluid">
	<div class="subform-repeatable-wrapper subform-layout 1222222">
			...
			<?php
				...
				?>
					<div class="btn-toolbar">
						<div class="col-xs-12">
							<span><?php echo Text::_('COM_JGIVE_GIVEAWAY_ADD_NOTE'); ?></span>
							<div class="btn-group pull-right">
								<a class="btn btn-mini fa fa-plus group-add-<?php echo $unique_subform_id; ?>"><span class="icon-plus"></span> </a>
							</div>
						</div>
					</div>
			<?php
